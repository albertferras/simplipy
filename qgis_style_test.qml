...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <displayfield>name_sort</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="pkid"/>
    <edittype labelontop="0" editable="1" type="0" name="simplified_geom_postgis"/>
    <edittype labelontop="0" editable="1" type="0" name="the_geom"/>
  </edittypes>
  <editform>.</editform>
